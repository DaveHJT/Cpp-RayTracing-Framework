...
redball = gr.nh_sphere('redball', {-200, 81, 210}, 80)
...
white_light = gr.light({100.0, 550.0, 0.0}, {0.9, 0.9, 0.9}, {1, 0, 0})
yellow_light = gr.light({700.0, 550.0, 600.0}, {1.0, 0.84, 0.7}, {0, -1, 0})
yellow_light2 = gr.light({-500.0, 550.0, -600.0}, {1.0, 0.84, 0.7}, {0, -1, 0})
yellow_light3 = gr.light({-500.0, 550.0, 600.0}, {1.0, 0.84, 0.7}, {0, -1, 0})
yellow_light4 = gr.light({700.0, 550.0, -600.0}, {1.0, 0.84, 0.7}, {0, -1, 0})


gr.render(scene_root, 'sample.png', 1080, 1080,
	  {-550, 200, -250}, {0, 0, 0}, {0, 1, 0}, 90,
